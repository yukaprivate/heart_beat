...
final scanStateNotifire = StateNotifierProvider.family<
        ConnectedDeviceStateNotifire, ScreenState, SetItemChildProps>(
    ((ref, props) => ConnectedDeviceStateNotifire(
          ref,
          props.context,
        )));

class ConnectedDeviceStateNotifire extends StateNotifier<ScreenState> {
  ConnectedDeviceStateNotifire(
    this._ref,
    this._context,
  ) : super(ScreenState(
          scanResults: [],
